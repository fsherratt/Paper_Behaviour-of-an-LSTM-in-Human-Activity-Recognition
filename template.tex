...
\begin{figure}[!hbt]
     ...
     \begin{subfigure}[b]{0.32\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/results/hidden_state/gyro_y_w_v_sa-sd/40_Participant_04.jpg}
         \caption{40\%}
     ...
     \begin{subfigure}[b]{0.32\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/results/hidden_state/gyro_y_w_v_sa-sd/60_Participant_04.jpg}
         \caption{60\%}
